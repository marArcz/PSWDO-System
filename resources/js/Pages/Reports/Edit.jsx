...
const Edit = ({ municipalities, typhoons, report }) => {
    ...
    const [selectedTwcsNo, setSelectedTwcsNo] = useState({
        value: report.typhoon_level,
        label: 'Signal No. ' + report.typhoon_level
    })
    ...
    const [selectedMunicipality, setSelectedMunicipality] = useState({
        value:report.municipality_id,
        label:report.municipality.name
    })
    const [selectedTyphoon, setSelectedTyphoon] = useState({
        value: report.calamity_id,
        label: report.calamity.name,
    })

    const { data, setData, patch, processing } = useForm({
        municipality: report.municipality.name,
        calamity: report.calamity.name,
        municipality_id: report.municipality_id,
        calamity_id: report.calamity_id,
        typhoon_level: report.typhoon_level,
        lce_present: report.lce_present,
        no_of_barangay_covered: report.no_of_barangay_covered,
        no_of_punong_barangay_present: report.no_of_punong_barangay_present,
        remarks: report.remarks,
        no_of_families: report.no_of_families,
        no_of_barangay: report.no_of_barangay,
        no_of_evacuation: report.no_of_evacuation,
        no_of_families_served: report.no_of_families_served,
        no_of_barangay_conducted_evacuation: report.no_of_barangay_conducted_evacuation,
        total_served: report.total_served,
        total_barangay_served: report.total_barangay_served,
        power_supply_status: report.power_supply_status,
        water_supply_status: report.water_supply_status,
        telecommunication_status: report.telecommunication_status,
        roads_and_bridges_status: report.roads_and_bridges_status,
    })
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        patch(route("pswdo.reports.update",report.id));
    }
    return (
        <DswdPanelLayout
            headerTitle='Reports'
            ...
            <Card className='border-0 shadow-sm'>
                <Card.Body className='p-lg-5 p-3'>
                    <Form onSubmit={onSubmit}>
                        <p className='text-dark fw-semibold fs-5'>Update Report</p>
                        <hr />
                            ...
                            <Col md>
                                ...
                                <Select
                                    ...
                                    onChange={(v) => {
                                        ...
                                        setData('municipality_id', v.value)
